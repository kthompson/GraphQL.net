...
let website = "/GraphQL.net"

let githubLink = "http://github.com/kthompson/GraphQL.net"

// Specify more information about your project
let info =
  [ "project-name", "GraphQL.net"
    "project-author", "Kevin Thompson"
    "project-summary", "An implementation of Facebook's GraphQL for .NET and F#."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/GraphQL.net" ]
