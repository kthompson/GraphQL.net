...
let project = "GraphQL.net"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "An implementation of Facebook's GraphQL for .NET and F#."

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "An implementation of Facebook's GraphQL for .NET and F#."

// List of author names (for NuGet package)
let authors = [ "Kevin Thompson" ]
...
let gitOwner = "kthompson"
let gitHome = "git@github.com:" + gitOwner

// The name of the project on GitHub
let gitName = "GraphQL.net"

// The url for the raw files hosted
let gitRaw = environVarOrDefault "gitRaw" "https://raw.github.com/kthompson"
